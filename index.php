            ...
            <ul>
                ...
                <li class=description><a href="livre/9782811611699.php"><img class=livre alt="SNK" src="img/ADT.jpg"></a></li>
                    <div>
                                    ...
                                    <strong>Edition VF :</strong> Pika<br>
                                    <strong>ISBN :</strong> 9782811611699<br>
            ...
            <ul>
                ...
                <li class=description><a href="livre/9782723457897.php"><img class=livre alt="DBZ" src="img/DBZ.jpg"></a></li>
                    <div>
                                    ...
                                    <strong>Type :</strong> Shonen<br>
                                    <strong>Edition VF :</strong> Glénat<br>
                                    <strong>ISBN :</strong> 9782723457897<br>
            ...
            <ul>
                ...
                <li class=description><a href="livre/9782811640569.php"><img class=livre alt="Fairy tail" src="img/Fairy_tail.jpg"></a>
                    <div>
                                    ...
                                    <strong>Type :</strong> Shonen<br>
                                    <strong>Edition VF :</strong> Pika<br>
                                    <strong>ISBN :</strong> 9782811640569<br>
                                    <strong>Date de parution: </strong>TOME 63: <time datetime="2018-06-27">27/06/2018</time><br>
                                    <strong>Auteur: </strong>Hiro Mashima</p>
                    </div>
                </li>
            </ul>
        </section>
            ...
            <ul>
                ...
                <li class=description><a href="livre/2505006474.php"><img class=livre alt="Hunter X hunter" src="img/HunterXhunter.jpg"></a>
                    <div>
                                    ...
                                    <strong>Type :</strong> Shonen<br>
                                    <strong>Edition VF :</strong>Kana<br>
                                    <strong>ISBN :</strong> 2505006474<br>
                                    <strong>Date de parution: </strong>TOME 1: <time datetime="2000-03-18">18/03/2000</time><br>
                                    <strong>Auteur: </strong>Togashi Yoshihiro</p>
                    </div>
                </li>
            </ul>
        </section>
            ...
            <ul>
                ...
                <li class=description><a href="livre/9782355929489.php"><img class=livre alt="My hero Academia" src="img/My_hero_Academia.jpg"></a>
                    <div>
                                    ...
                                    <strong>Type :</strong> Shonen<br>
                                    <strong>Edition VF :</strong>Ki-oon<br>
                                    <strong>ISBN :</strong> 9782355929489<br>
                                    <strong>Date de parution: </strong>TOME 1: <time datetime="2016-04-14">14/04/2016</time><br>
                                    <strong>Auteur: </strong>Horikoshi Kohei</p>
                    </div>
                </li>
            </ul>
        </section>
            ...
            <ul>
                ...
                <li class=description><a href="livre/9782871294146.php"><img class=livre alt="Naruto" src="img/Naruto.jpg"></a>
                    <div>
                                    ...
                                    <strong>Type :</strong> Shonen<br>
                                    <strong>Edition VF :</strong> Kana<br>
                                    <strong>ISBN :</strong> 9782871294146<br>
                                    <strong>Date de parution: </strong>TOME 1: <time datetime="2002-03-09">09/03/2002</time><br>
                                    <strong>Auteur: </strong>Kishimoto Masashi</p>
                    </div>
                </li>
            </ul>
        </section>
            ...
            <ul>
                ...
                <li class=description><a href="livre/9782723488525.php"><img class=livre alt="One piece" src="img/One_piece.jpg"></a>
                    <div>
                                    ...
                                    <strong>Date de parution: </strong>TOME 1: <time datetime="2013-07-03">03/07/2013</time><br>
                                    <strong>Auteur: </strong>Oda Eiichiro</p>
                    </div>
                </li>
            </ul>
        </section>
            ...
            <ul>
                ...
                <li class=description><a href="livre/9782368522257.php"><img class=livre alt="One punch man" src="img/One_punch_man.jpg"></a>
                    <div>
                                    ...
                                    <strong>Edition VF :</strong>Kurokawa<br>
                                    <strong>ISBN :</strong> 9782368522257<br>
                                    <strong>Date de parution: </strong>TOME 1: <time datetime="2016-01-14">14/01/2016</time><br>
                                    <strong>Auteur: </strong>Yusuke Murata</p>
                    </div>
                </li>
            </ul>
        </section>
            ...
            <ul>
                ...
                <li class=description><a href="livre/9782377170067.php"><img class=livre alt="Re Zero" src="img/Re_Zero.jpg"></a>
                    <div>
                                    ...
                                    <strong>ISBN :</strong> 9782377170067<br>
                                    <strong>Date de parution: </strong>TOME 1: <time datetime="2017-04-15">15/04/2017</time><br>
                                    <strong>Auteur: </strong>Tappei Nagatsuki</p>
                    </div>
                </li>
            </ul>
        </section>
